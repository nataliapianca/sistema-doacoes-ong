...
class Relatorio:
    ...
    def get_relatorio_campanhas(self):
        ...
        print(postgree.sqlToDataFrame(self, self.query_relatorio_campanhas))
    ...
    def get_relatorio_doacoes(self):
        ...
        print(postgree.sqlToDataFrame(self, self.query_relatorio_doacoes))
    ...
    def get_relatorio_pessoas(self):
        ...
        print(postgree.sqlToDataFrame(self, self.query_relatorio_pessoas))
